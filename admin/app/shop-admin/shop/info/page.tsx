                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                    <div className="flex flex-wrap gap-4">
                        <a
                            ...
                            className="flex-1 min-w-[200px] bg-gradient-to-r from-[#db4444] to-[#c73e3e] text-white font-semibold py-3 px-6 rounded-xl hover:from-[#c73e3e] hover:to-[#b83838] transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center"
                        >
                            <TrendingUp className="w-5 h-5 inline mr-2" />
                            Xem thống kê
                        </a>
                        <a
                            href="/shop-admin/shop/update"
                            className="flex-1 min-w-[200px] bg-white border-2 border-gray-200 text-gray-700 font-semibold py-3 px-6 rounded-xl hover:border-[#db4444] hover:text-[#db4444] transition-all duration-300 transform hover:scale-105 flex items-center justify-center"
                        >
