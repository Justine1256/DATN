...
public function stats(Request $request)
{
    ...
    // Tổng sản phẩm đang bán (kích hoạt)
    ...
    // Lấy rating trung bình các sản phẩm có ít nhất 1 đánh giá
    ...
    $averageRating = $productRatings->count() > 0
        ? round($productRatings->avg(), 1)
        : null;

    // Tổng đánh giá (dựa trên order_detail -> product -> shop)
