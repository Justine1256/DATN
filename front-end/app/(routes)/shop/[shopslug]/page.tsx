...
const ShopPage = () => {
    ...
    const fetchData = useCallback(async (categorySlug: string | null = null) => {
        ...
        try {
            const shopUrl = `${API_BASE_URL}/shop/${shopslug}`;
            const categoryUrl = `${API_BASE_URL}/shop/${shopslug}/categories`;
            ...
            let productUrl = categorySlug
                ? `${API_BASE_URL}/shop/${shopslug}/products-by-category/${categorySlug}`
                : `${API_BASE_URL}/shop/${shopslug}/products`;
