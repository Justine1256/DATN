...
import { Result, Button, Card, Typography, Descriptions, Space, Divider } from "antd"
import { CheckCircleTwoTone, HomeOutlined, ShoppingOutlined } from "@ant-design/icons"
        ...
        <Space direction="vertical" size={12} style={{ width: "100%" }}>
          <Result
            ...
            title={
              <Space direction="vertical" size={6}>
                ...
                <Text type="secondary">Cảm ơn bạn đã mua sắm. Chúng tôi đang xử lý đơn và sẽ sớm giao đến bạn.</Text>
              </Space>
            }
          ...
          <Card bordered style={{ borderRadius: 12 }} bodyStyle={{ padding: 16 }}>
            <Space direction="vertical" size={4}>
              ...
              <Text type="secondary">• Bạn sẽ nhận được email/Xác nhận trong tài khoản khi đơn được xác nhận.</Text>
              <Text type="secondary">• Hãy giữ lại mã đơn hàng để tiện tra cứu hỗ trợ.</Text>
            </Space>
          </Card>
        </Space>
      </Card>
