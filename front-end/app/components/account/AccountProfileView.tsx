      ...
      <div className="p-6">
        ...
        <div className="flex items-center gap-6 mb-6">
          ...
          <div className="flex-shrink-0">
            ...
            />
            <div className="w-16 h-16 rounded-full border-2 border-gray-200 bg-[#DB4444] hidden items-center justify-center">
          ...
          <div className="flex-1">
            ...
            <div className="inline-flex items-center gap-1 bg-blue-100 text-blue-600 px-2 py-1 rounded-full text-xs font-medium mt-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
            <div className="w-8 h-8 bg-[#DB4444] rounded-full flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="font-medium text-gray-800 text-sm truncate">{user.phone}</p>
            </div>
          </div>
        </div>
      </div>
