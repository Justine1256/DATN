        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center justify-between p-6 border-b border-gray-200">
                    <div>
                        <h3 className="text-xl font-bold text-gray-900">Tố cáo shop</h3>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="flex items-start gap-3 p-4 bg-red-50 border border-red-200 rounded-xl">
                        ...
                        <div className="text-sm text-red-800">
                            ...
                            <ul className="list-disc list-inside space-y-1">
                                <li>Chỉ tố cáo khi shop từ chối yêu cầu hoàn đơn</li>
                                <li>Vui lòng cung cấp hình ảnh minh chứng rõ ràng</li>
                                <li>Thông tin tố cáo sai sự thật có thể bị xử lý</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Vui lòng mô tả lý do tố cáo..."
                    ...
                    <div className="flex gap-3 pt-4">
                        ...
                        >
                            {isProcessing ? "Đang gửi..." : "Gửi tố cáo"}
                        </button>
                    </div>
                </form>
            </div>
